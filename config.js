...
const PLAYER_TIERS = [
    { label: 'Iniciado',     minVersion: 0.0, versionRange: [0.5, 1.00], toolVersionRange: [0.8, 1.5], reqPorts: [1, 1], totalPortsRange: [2, 3], services: ['SSH', 'HTTP', 'SQL'], traceChance: 0.00, traceDurationBase: [0, 0],     rewardMult: 0.7, decorativeRange: [0, 1], firewallChance: 0.00 },
    { label: 'Novato',       minVersion: 1.2, versionRange: [0.9, 1.35], toolVersionRange: [1.1, 1.7], reqPorts: [1, 2], totalPortsRange: [3, 4], services: ['SSH', 'HTTP', 'SQL', 'FTP'], traceChance: 0.15, traceDurationBase: [18, 30],   rewardMult: 1.0, decorativeRange: [0, 1], firewallChance: 0.00 },
    { label: 'Operador',     minVersion: 1.6, versionRange: [1.2, 1.65], toolVersionRange: [1.5, 2.1], reqPorts: [2, 2], totalPortsRange: [4, 5], services: ['SSH', 'HTTP', 'SQL', 'FTP', 'SMTP'], traceChance: 0.30, traceDurationBase: [22, 38],   rewardMult: 1.4, decorativeRange: [0, 2], firewallChance: 0.20 },
    { label: 'Especialista', minVersion: 2.0, versionRange: [1.6, 2.05], toolVersionRange: [1.9, 2.5], reqPorts: [2, 3], totalPortsRange: [4, 6], services: ['SSH', 'HTTP', 'SQL', 'FTP', 'SMTP', 'TELNET'], traceChance: 0.45, traceDurationBase: [26, 45],   rewardMult: 1.8, decorativeRange: [0, 2], firewallChance: 0.35 },
    { label: 'Veterano',     minVersion: 2.4, versionRange: [2.0, 2.45], toolVersionRange: [2.3, 2.9], reqPorts: [3, 3], totalPortsRange: [5, 7], services: ['SSH', 'HTTP', 'SQL', 'FTP', 'SMTP', 'TELNET', 'DNS'], traceChance: 0.55, traceDurationBase: [30, 52],   rewardMult: 2.2, decorativeRange: [0, 2], firewallChance: 0.45 },
    { label: 'Élite',        minVersion: 2.8, versionRange: [2.4, 2.85], toolVersionRange: [2.7, 3.3], reqPorts: [3, 4], totalPortsRange: [6, 7], services: ['SSH', 'HTTP', 'SQL', 'FTP', 'SMTP', 'TELNET', 'DNS'], traceChance: 0.65, traceDurationBase: [34, 58],   rewardMult: 2.8, decorativeRange: [0, 1], firewallChance: 0.55 },
    { label: 'Maestro',      minVersion: 3.2, versionRange: [2.8, 3.25], toolVersionRange: [3.1, 3.7], reqPorts: [4, 4], totalPortsRange: [6, 7], services: ['SSH', 'HTTP', 'SQL', 'FTP', 'SMTP', 'TELNET', 'DNS'], traceChance: 0.75, traceDurationBase: [38, 65],   rewardMult: 3.5, decorativeRange: [0, 1], firewallChance: 0.65 },
    { label: 'Fantasma',     minVersion: 3.6, versionRange: [3.2, 3.65], toolVersionRange: [3.5, 4.1], reqPorts: [4, 5], totalPortsRange: [6, 7], services: ['SSH', 'HTTP', 'SQL', 'FTP', 'SMTP', 'TELNET', 'DNS'], traceChance: 0.85, traceDurationBase: [42, 72],   rewardMult: 4.2, decorativeRange: [0, 1], firewallChance: 0.75 },
    { label: 'Singularidad', minVersion: 4.0, versionRange: [3.6, 4.20], toolVersionRange: [3.9, 5.0], reqPorts: [5, 5], totalPortsRange: [7, 7], services: ['SSH', 'HTTP', 'SQL', 'FTP', 'SMTP', 'TELNET', 'DNS'], traceChance: 0.90, traceDurationBase: [46, 80],   rewardMult: 5.0, decorativeRange: [0, 0], firewallChance: 0.85 }
];
